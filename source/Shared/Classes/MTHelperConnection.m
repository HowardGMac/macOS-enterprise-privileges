...
@implementation MTHelperConnection
...
#pragma clang diagnostic ignored "-Warc-retain-cycles"
        [_connection setInvalidationHandler:^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                os_log(OS_LOG_DEFAULT, "SAPCorp: Helper connection invalidated");
        ...
        [_connection setInterruptionHandler:^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                os_log(OS_LOG_DEFAULT, "SAPCorp: Helper connection interrupted");
                self->_connection = nil;
            });
        }];
